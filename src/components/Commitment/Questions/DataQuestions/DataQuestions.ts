...
export const DataQuestions: iDataQuestion[] = [
    ...
    {
        question: "Responsible Research",
        response: "To ensure we're building responsible learning experiences using immersive technologies, we're working with universities and investing in research",
    },
    {
